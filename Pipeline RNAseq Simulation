...
# Generating yml file
conda env export > phindhack_covdifex.yml
...
# Downloading Annotated Ref sequence and converting to gtf file
...
gunzip -df Saccharomyces_cerevisiae.R64-1-1.101.chromosome.VIII.gff3.gz
gffread Saccharomyces_cerevisiae.R64-1-1.101.chromosome.VIII.gff3 -T -o Saccharomyces_cerevisiae.R64-1-1.101.chromosome.VIII.gtf

# Indexation
STAR --runMode genomeGenerate \ 
     --genomeDir index_star_chr8 \
     --genomeFastaFiles ~/reference_chr8/Saccharomyces_cerevisiae.R64-1-1.dna.chromosome.VIII.fa \
     --sjdbGTFfile ~/reference_chr8/Saccharomyces_cerevisiae.R64-1-1.101.chromosome.VIII.gtf \
...
cat SRR11241433_1.counts.txt

# Comparaison between htseq and STAR


# Alignment QC     
 qualimap  rnaseq -bam ~/alignments_STAR/SRR11241433_1_trimAligned.sortedByCoord.out.bam \
          -gtf ~/reference_chr8/Saccharomyces_cerevisiae.R64-1-1.101.chromosome.VIII.gtf \
          -outdir qc_qualimap \
